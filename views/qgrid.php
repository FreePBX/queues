...
foreach($queuelist as $q){
	$qrows .= '<tr><td>'.$q[0].'</td><td>'.$q[1].'</td><td><a href="?display=queues&view=form&extdisplay='.urlencode($q[0]).'"><i class="fa fa-edit"></i></a>&nbsp;<a href="?display=queues&action=delete&account='.urlencode($q[0]).'"><i class="fa fa-trash"></i></a></td></tr>';
}
?>
<div id="toolbar-all">
