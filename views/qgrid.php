...
foreach($queuelist as $q){
	$qrows .= '<tr><td>'.$q[0].'</td><td>'.$q[1].'</td><td><a href="?display=queues&view=form&extdisplay='.htmlentities((string) $q[0]).'"><i class="fa fa-edit"></i></a>&nbsp;<a href="?display=queues&action=delete&account='.htmlentities((string) $q[0]).'" class="delAction"><i class="fa fa-trash"></i></a></td></tr>';
}
?>
<div id="toolbar-all">
