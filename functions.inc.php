...
// and cause a bug.
function queues_get_field_size($fieldname, $defaultsize) {
        global $db;

        $sql = "select character_maximum_length from information_schema.columns where table_name = 'queues_config' and column_name = '$fieldname';";
